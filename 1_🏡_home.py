...
st.sidebar.markdown('Desenvolvido por [Matheus Andrade](www.linkedin.com/in/andradeematheus)')

btn = st.button('Acesse meu GitHub')
if btn:
    webbrowser.open_new_tab('https://github.com/andrade044')
